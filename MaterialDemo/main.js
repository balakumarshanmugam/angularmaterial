...
/* harmony import */ var _icon_snack_bar_icon_snack_bar_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./icon-snack-bar/icon-snack-bar.component */ "./src/app/icon-snack-bar/icon-snack-bar.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            declarations: [
                ...
                _icon_snack_bar_icon_snack_bar_component__WEBPACK_IMPORTED_MODULE_15__["IconSnackBarComponent"]
            ],
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_6__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].firebaseConfig)
            ],
            entryComponents: [_employees_employee_employee_component__WEBPACK_IMPORTED_MODULE_10__["EmployeeComponent"], _icon_snack_bar_icon_snack_bar_component__WEBPACK_IMPORTED_MODULE_15__["IconSnackBarComponent"]],
            providers: [_shared_employee_service__WEBPACK_IMPORTED_MODULE_11__["EmployeeService"], _shared_department_service__WEBPACK_IMPORTED_MODULE_13__["DepartmentService"]],
...
var EmployeeListComponent = /** @class */ (function () {
    function EmployeeListComponent(employeeService, dialog) {
        this.employeeService = employeeService;
        this.dialog = dialog;
        this.displayedColumns = ['fullName', 'email', 'mobile', 'city', 'actions'];
    }
    EmployeeListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.employeeService.getEmployees().subscribe(function (list) {
            var employeesArray = list.map(function (item) {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ $key: item.key }, item.payload.val());
            });
            _this.listData = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](employeesArray);
    ...
    EmployeeListComponent.prototype.clearSearch = function () {
        this.searchKey = "";
        this.applyFilter();
    };
...
/***/ "./src/app/icon-snack-bar/icon-snack-bar.component.css":
/*!*************************************************************!*\
  !*** ./src/app/icon-snack-bar/icon-snack-bar.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2ljb24tc25hY2stYmFyL2ljb24tc25hY2stYmFyLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/icon-snack-bar/icon-snack-bar.component.html":
/*!**************************************************************!*\
  !*** ./src/app/icon-snack-bar/icon-snack-bar.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = "<mat-icon>{{ data?.icon }}</mat-icon> <span>&nbsp;{{ data?.message }}</span>"

/***/ }),

/***/ "./src/app/icon-snack-bar/icon-snack-bar.component.ts":
/*!************************************************************!*\
  !*** ./src/app/icon-snack-bar/icon-snack-bar.component.ts ***!
  \************************************************************/
/*! exports provided: IconSnackBarComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconSnackBarComponent", function() { return IconSnackBarComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
// ...
var IconSnackBarComponent = /** @class */ (function () {
    function IconSnackBarComponent(data) {
        this.data = data;
    }
    IconSnackBarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'icon-snack-bar',
            template: __webpack_require__(/*! ./icon-snack-bar.component.html */ "./src/app/icon-snack-bar/icon-snack-bar.component.html"),
            styles: [__webpack_require__(/*! ./icon-snack-bar.component.css */ "./src/app/icon-snack-bar/icon-snack-bar.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_1__["MAT_SNACK_BAR_DATA"])),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object])
    ], IconSnackBarComponent);
    return IconSnackBarComponent;
}());
...
var DepartmentService = /** @class */ (function () {
    function DepartmentService(firebase) {
        ...
        this.departmentList.snapshotChanges().subscribe(function (list) {
            _this.departmentArray = list.map(function (item) {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ $key: item.key }, item.payload.val());
            });
        });
    }
...
/* harmony import */ var _icon_snack_bar_icon_snack_bar_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../icon-snack-bar/icon-snack-bar.component */ "./src/app/icon-snack-bar/icon-snack-bar.component.ts");
...
var NotificationService = /** @class */ (function () {
    ...
    NotificationService.prototype.success = function (msg) {
        this.config['panelClass'] = ['notification', 'success', 'center'];
        //this.snackBar.open(msg, '', this.config);
        this.snackBar.openFromComponent(_icon_snack_bar_icon_snack_bar_component__WEBPACK_IMPORTED_MODULE_3__["IconSnackBarComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {
                message: msg,
                icon: 'done'
            } }, this.config));
    };
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyBqkbqP14yJHAkRedTeNCDQUNjbGgSd2xU",
        authDomain: "amcrud-9886d.firebaseapp.com",
        databaseURL: "https://amcrud-9886d.firebaseio.com",
        projectId: "amcrud-9886d",
        storageBucket: "amcrud-9886d.appspot.com",
        messagingSenderId: "962851386745"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\users\pu29cl\project\angular\MaterialDemo\src\main.ts */"./src/main.ts");
